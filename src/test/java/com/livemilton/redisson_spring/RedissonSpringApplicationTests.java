package com.livemilton.redisson_spring;
...
@SpringBootTest
class RedissonSpringApplicationTests {
	...
	void springDataRedsTest() {
		...
		Mono<Void> mono = Flux.range(1, 500_000)
				.flatMap(i -> valueOperations.increment("user:1:visit")).then();
